                ...
                error ? (
                    ...
                    fetched ? (
                        reviews.length ? (
                            ...
                            <div className = "flex items-center justify-center border border-b-2 border-r-2 border-cyan-400 rounded-md w-full md:w-[50%] m-auto">
                                <div className = "flex m-auto place-center justify-center">
                                    <h1 
                                        className="font-bold py-4"
                                    >
                                        There is No Review Yet please put an 
                                        <Link className="ml-1 underline underline-offset-1 text-emerald-500" href="/write-review">Review</Link>
                                    </h1>
                                </div>
                            </div>
                        )
